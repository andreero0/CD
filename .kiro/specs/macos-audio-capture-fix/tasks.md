...
- [ ] 1. Build universal SystemAudioDump binary
...
- [ ] 2. Create architecture detection module
  - [ ] 2.1 Implement getSystemArchitecture() function
    - Use process.arch to detect current architecture
    - Map Node.js arch names to macOS arch names (x64 → x86_64, arm64 → arm64)
    - _Requirements: 2.5, 7.2_

  - [ ] 2.2 Implement getBinaryArchitectures() function
  ...
  - [ ] 2.3 Implement binarySupportsArchitecture() function
    - Call getBinaryArchitectures()
    - Check if required architecture is in the list
    - Return boolean result
    - _Requirements: 2.2, 2.4_

  - [ ] 2.4 Write property test for architecture detection
    - **Property 7: Architecture Detection Consistency**
    - **Validates: Requirements 2.5**

- [ ] 3. Create binary verification module
  - [ ] 3.1 Implement checkCodeSignature() function
  ...
  - [ ] 3.2 Implement verifySystemAudioDump() function
  ...
  - [ ] 3.3 Write property test for verification idempotence
    - **Property 2: Binary Verification Idempotence**
    - **Validates: Requirements 5.1**

- [ ] 4. Create error diagnostics module
  - [ ] 4.1 Implement diagnoseSpawnError86() function
  ...
  - [ ] 4.2 Implement formatErrorMessage() function
  ...
  - [ ] 4.3 Write property test for error diagnosis completeness
    - **Property 3: Error Diagnosis Completeness**
    - **Validates: Requirements 4.1, 5.1**

- [ ] 5. Implement retry strategy with exponential backoff
  - [ ] 5.1 Create RetryStrategy class
    - Track attempt count
...
- [ ] 6. Create Audio Capture Manager
  - [ ] 6.1 Implement AudioCaptureManager class structure
  ...
  - [ ] 6.2 Implement verifyBinary() method
  ...
  - [ ] 6.3 Implement diagnoseError() method
  ...
  - [ ] 6.4 Implement initialize() method
  ...
  - [ ] 6.5 Implement start() method with retry logic
  ...
  - [ ] 6.6 Implement stop() method with cleanup
  ...
  - [ ] 6.7 Write property test for resource cleanup
    - **Property 5: Resource Cleanup**
    - **Validates: Requirements 5.2**

- [ ] 7. Implement fallback audio capture methods
  - [ ] 7.1 Implement tryDesktopCapturer() function
  ...
  - [ ] 7.2 Implement tryWebAudioCapture() function
  ...
  - [ ] 7.3 Integrate fallback methods into AudioCaptureManager
  ...
  - [ ] 7.4 Write property test for fallback activation
    - **Property 4: Fallback Activation**
    - **Validates: Requirements 7.1, 7.2**

- [ ] 8. Integrate AudioCaptureManager into existing code
  - [ ] 8.1 Refactor startMacOSAudioCapture() in gemini.js
  ...
  - [ ] 8.2 Update stopMacOSAudioCapture() in gemini.js
    - Use AudioCaptureManager.stop() instead of direct process.kill()
    - Ensure proper cleanup
    - _Requirements: 5.2_

  - [ ] 8.3 Update killExistingSystemAudioDump() function
    - Add architecture-aware process detection
    - Handle both x86_64 and arm64 processes
    - _Requirements: 5.4_

- [ ] 9. Add permission handling
  - [ ] 9.1 Implement checkAudioPermissions() function
    - Check macOS audio capture permissions status
    - Return permission state
    - _Requirements: 6.1, 6.3_

  - [ ] 9.2 Implement requestAudioPermissions() function
    - Prompt user for audio capture permissions
    - Wait for user response
    - Return granted status
    - _Requirements: 6.2_

  - [ ] 9.3 Integrate permission checks into AudioCaptureManager
  ...
  - [ ] 9.4 Write property test for permission state consistency
    - **Property 8: Permission State Consistency**
    - **Validates: Requirements 6.3**

- [ ] 10. Update build configuration
  - [ ] 10.1 Add binary verification to build process
...
- [ ] 12. Add comprehensive logging
  - [ ] 12.1 Add structured logging for audio capture lifecycle
  ...
  - [ ] 12.2 Add diagnostic logging for errors
...
- [ ] 13. Create user-facing error messages
  - [ ] 13.1 Design error message UI component
  ...
  - [ ] 13.2 Integrate error messages into renderer
